      ...
      <div>
          ...
          <div class="row">
            ...
            <div class="col-lg-9 col-sm-12">
              <div class="row mo-display-flex">
                ...
                <div class="col-lg-6 col-sm-6 mo-display-flex-half">
                  <input class="search-date" name="reservationStartDate" type="time" value="<fmt:formatDate value="${reservation.reservationStartDate}" pattern="HH:mm" />" disabled style="background-color: #ffffff">
                </div>
              </div>
            </div>
            <div class="col-lg-1 d-none d-lg-block">
          ...
          <div class="notice-type-search-container">
            <div class="row">
              ...
              <div class="col-lg-9 col-sm-12">
                <div class="row mo-display-flex">
                  <div class="col-lg-6 col-sm-6 mo-display-flex-half">
                    <input class="search-date" name="reservationEndDate" type="date" value="<fmt:formatDate value="${reservation.reservationEndDate}" pattern="yyyy-MM-dd"/>" disabled style="background-color: #ffffff">
                  </div>
                  <div class="col-lg-6 col-sm-6 mo-display-flex-half">
                    <input class="search-date" name="reservationEndDate" type="time" value="<fmt:formatDate value="${reservation.reservationEndDate}" pattern="HH:mm"/>"  disabled style="background-color: #ffffff">
                  </div>
                </div>
              </div>
              <div class="col-lg-1 d-none d-lg-block">
        ...
        <div class="date-search-container" style="clear: both; margin-top: 10px;">
          <div class="row">
            ...
            <div class="col-lg-9 col-sm-12">
              <input class="form-control" type="text" name="note" value="${reservation.note}" placeholder="비고입력" disabled style="background-color: #ffffff">
            </div>
            <div class="col-lg-1 d-none d-lg-block">
            </div>
          </div>
        ...
        <div class="search-btn-container">
          ...
          <button class="btn btn-outline-secondary filter-btn" onClick="location.href='/reservation/modify?reservationSeq=${reservation.reservationSeq}'">수정</button>
        </div>
      </div>
    </div>
  </div>
